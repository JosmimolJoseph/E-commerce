...
namespace E_commerce
{
    public partial class View_Single_Product : System.Web.UI.Page
    {
        ...
        {
            string s = "select max(Cart_Id) from Cart_Product";
            ...
            int t_price = q * p;
            string d = "insert into Cart_Product values(" + cart_id + "," + TextBox1.Text + "," + t_price + ",'available'," + Session["userid"] + "," + Session["Product_Id"] + ")";
